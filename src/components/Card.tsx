...
export const Card = React.memo(function Card({ value, isFlipped, isMatched, index} : propTypes) {
    ...
    return (
        <button disabled={isMatched} onClick={() => handleCardClick(index)}  className="w-20 h-28 sm:w-24 sm:h-32 md:w-40 md:h-45 lg:h-50 lg:w-40 rounded border-2 bg-sky-500 hover:bg-sky-700">
